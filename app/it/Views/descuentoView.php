...
Route::getJs(array("scriptdescuento"), "it", array(), FALSE);
...
<div class="row">
    <div class="col s4 m4 l4">
        <h4><i class="fa fa-money teal-text" aria-hidden="true"></i>&nbsp;Descuentos</h4>
    </div>
...
<div class="row">
    <div class="col s12">
        <ul class="tabs">
            ...
            <li class="tab col s3 info3"><a data-info="tipo" href="#test3">Tipos descuentos</a></li>
        </ul>
    </div>
<!--        tab sub categoria       -->
    ...
    <div id="test3" class="col s12">
        ...
        <form id="records2">
            <div class="row center-align">
                ...
                <div class="col s2">
                    <br>
                    <a class="waves-effect waves-light waves-green btn dark-primary-color" id="save3">Save</a>
                </div>
            </div>
        </form>
        <!--table-->
        <div class="row">
            <table class="display cell-border compact order-column mdl-data-table bordered"  cellspacing="0" width="100%" id="details2" >
                <thead>
                <tr class="accent-color white-text">
                    <th>#</th>
