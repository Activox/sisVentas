<?php
Route::getJs(array("scriptunidad"), "it", array(), FALSE);
...
<div class="row">
    <div class="col s4 m4 l4">
        <h4><i class="small material-icons teal-text">list</i>&nbsp;Unidades</h4>
...
<div class="row container">
    ...
    <table class="bordered striped highlight centered responsive-table">
        ...
        <tr class="accent-color white-text">
            ...
            <th data-field="name">Description Corta</th>
    ...
    <div class="modal-content">
        ...
        <div class="row">
            <form class="col s12" id="records">
                ...
                <div class="input-field col s4">
                    <input id="sdescription" type="text" class="validate">
                    <label for="sdescription">Descripcion Corta</label>
                </div>
                <div class="input-field col s4">
                    <input id="cant" type="number" class="validate">
                    <label for="cant">Cant. Referencia</label>
                </div>
            </form>
        </div>
    </div>
