...
<div class="row">
    <div class="col s9 m9 l9">
        <h4 class="header"><span><i class=" material-icons teal-text" style="font-size: 40px">store</i></span> Almacen</h4>
    </div>
    ...
    <div class="col s12 m12 l4">
        <ul class="collection with-header z-depth-3">
            <center>  <li href="#!" class="collection-header teal white-text"><h4>Aplicaciones</h4></li>
                <a href="almacen-aplicaciones-inventario" class="collection-item">Entrada a Inventario</a></center>
        </ul>
    </div> 
    <!--/ Aplicaciones-->
    ...
    <div class="col s12 m12 l4">
        <ul class="collection with-header z-depth-3">
            <center>  <li href="#!" class="collection-header teal white-text"><h4>Reportes</h4></li>
                <a href="almacen-reportes-existencia" class="collection-item">Productos en existencia</a></center>
        </ul>
    </div>
    <!--/ Reportes-->
