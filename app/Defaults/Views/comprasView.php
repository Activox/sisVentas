...
<div class="row">
    ...
    <div class="col s12 m12 l4 center-align">
        <ul class="collection with-header z-depth-3">
            ...
            <a href="compras-aplicaciones-ordenes" class="collection-item">Ordenes de Compra</a>
        </ul>
    </div>
    <!--/ Aplicaciones-->
    ...
    <div class="col s12 m12 l4 center-align">
        <ul class="collection with-header z-depth-3">
            ...
            <a href="compras-aplicaciones-ReportesOrdenes" class="collection-item">Ordenes Compras</a>
        </ul>
    </div>
    <!--/ Reportes-->
